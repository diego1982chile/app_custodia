...
public class InstitucionesAutoCompleteView extends AutoCompleteTextView {

    public InstitucionesAutoCompleteView(Context context) {
        super(context);
        init(context);
        // TODO Auto-generated constructor stub
    }

    public InstitucionesAutoCompleteView(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(context);
        // TODO Auto-generated constructor stub
    }

    public InstitucionesAutoCompleteView(Context context, AttributeSet attrs, int defStyle) {
