...
import test3.ncxchile.cl.helpers.RutParser;
        ...
        try {
            ...
            if(acta.getVehiculoData()!=null){
                ...
                if(acta.getVehiculoData().getVehiculo()!=null) {
                    ...
                    if (vehiculoDataTemplateJson != null) {
                        ...
                        if (vehiculoTemplateJson != null) {
                            ...
                            vehiculoJson.putOpt("tamano", vehiculoTemplateJson.optString("tamano"));
                    ...
                    if (acta.getVehiculoData().getClientePropietario().size() > 0) {
                        ...
                        propietarioJson.putOpt("rut", RutParser.formatRut(acta.getVehiculoData().getClientePropietario().get(0).getPersona().getRut()));
                    ...
                    if (acta.getVehiculoData().getClientePropietario().size() > 1) {
                        ...
                        conductorJson.putOpt("rut", RutParser.formatRut(acta.getVehiculoData().getClientePropietario().get(1).getPersona().getRut()));
                ...
                if(acta.getAutoridad()!=null){
                    ...
                    autoridadJson.putOpt("rut",RutParser.formatRut(acta.getAutoridad().getPersona().getRut()));
