 ...
 */
public class FragmentX6_2 extends android.app.Fragment {
    ...
    public FragmentX6_2 newInstance(int sectionNumber) {
        FragmentX6_2 fragment = new FragmentX6_2();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        fichaEstadoVisualList=new ArrayList<FichaEstadoVisual>();
