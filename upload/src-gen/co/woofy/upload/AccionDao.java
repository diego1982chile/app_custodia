...
public class AccionDao extends AbstractDao<Accion, Long> {
    ...
    */
    public static class Properties {
        ...
        public final static Property Sincronizada = new Property(4, Boolean.class, "sincronizada", false, "SINCRONIZADA");
        public final static Property IdTarea = new Property(5, long.class, "idTarea", false, "ID_TAREA");
        public final static Property IdActa = new Property(6, Long.class, "idActa", false, "ID_ACTA");
    };
    ...
    public static void createTable(SQLiteDatabase db, boolean ifNotExists) {
        ...
        db.execSQL("CREATE TABLE " + constraint + "'ACCION' (" + //
                ...
                "'SINCRONIZADA' INTEGER," + // 4: sincronizada
                "'ID_TAREA' INTEGER NOT NULL ," + // 5: idTarea
                "'ID_ACTA' INTEGER);"); // 6: idActa
    }
    ...
    protected void bindValues(SQLiteStatement stmt, Accion entity) {
        ...
        if (sincronizada != null) {
            stmt.bindLong(5, sincronizada ? 1l: 0l);
        }
        stmt.bindLong(6, entity.getIdTarea());
 
        Long idActa = entity.getIdActa();
        if (idActa != null) {
            stmt.bindLong(7, idActa);
        }
    }
    ...
    public Accion readEntity(Cursor cursor, int offset) {
        Accion entity = new Accion( //
            ...
            cursor.isNull(offset + 4) ? null : cursor.getShort(offset + 4) != 0, // sincronizada
            cursor.getLong(offset + 5), // idTarea
            cursor.isNull(offset + 6) ? null : cursor.getLong(offset + 6) // idActa
        );
        return entity;
    }
    ...
    public void readEntity(Cursor cursor, Accion entity, int offset) {
        ...
        entity.setSincronizada(cursor.isNull(offset + 4) ? null : cursor.getShort(offset + 4) != 0);
        entity.setIdTarea(cursor.getLong(offset + 5));
        entity.setIdActa(cursor.isNull(offset + 6) ? null : cursor.getLong(offset + 6));
     }
